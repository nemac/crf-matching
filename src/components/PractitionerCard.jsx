      ...
      <Card
        sx={{
          ...
          border: isSelectedForComparison
            ...
            : practitioner.org_registry_category === 'Specialist'
              ? `1px solid ${theme.palette.primary.lightTan}`
      ...
      >
        ...
        >
          ...
          <Typography variant="body2" color="text.secondary" sx={{ mb: 2 }}>
            Headquartered in: {practitioner.org}
          </Typography>
          ...
          <Box sx={{ mb: 2 }}>
            ...
            >
              {practitioner.org_registry_category === 'Specialist' &&
                'Specialty'}
              {practitioner.org_registry_category ===
                'Broad service provider' && 'Services Provided'}
            </Typography>
            <Box
              sx={{
                display: 'flex',
