      ...
      >
        ...
        <Box sx={{ mb: 6 }}>
          ...
          >
            ...
            <Chip sx={{display:{  xs: 'flex',  sm: 'inline-flex', md: 'inline-flex' }, maxWidth: '150px', mx: 2, mb: 6, p: 2, backgroundColor: lightBlue[400], color: 'primary.main'  }} label='Beta version'  size="small" />
          </Typography>
          <Typography
            sx={{
              mb: 3,
